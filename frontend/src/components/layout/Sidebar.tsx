...
const navItems: readonly NavItem[] = [
  ...
  },
  {
    ...
    label: 'HUD',
    iconPath:
      'M3.75 6.75h16.5v10.5H3.75z M8.25 20.25h7.5 M12 17.25v3',
  },
];

function NavIcon({ iconPath }: { readonly iconPath: string }) {
  return (
    <svg
      aria-hidden="true"
      fill="none"
...
export function Sidebar() {
  return (
    <aside className="app-rail">
      <div className="app-rail__brand">aplan</div>
      <nav className="app-rail__nav">
        {navItems.map(item => (
          <NavLink
            ...
            to={item.path}
            className={({ isActive }) =>
              isActive ? 'app-rail__link app-rail__link--on' : 'app-rail__link'
            }
          >
            <NavIcon iconPath={item.iconPath} />
